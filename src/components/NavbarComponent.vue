...
import { hasAdminConfig } from "@/utils/admin";
...
const showAdmin = computed(() => hasAdminConfig());
...
<template>
    <mdui-navigation-rail v-if="!props.isMobile" :value="activeValue" divider>
        ...
        <mdui-navigation-rail-item v-if="showAdmin" icon="dashboard--outlined" value="admin" @click="navigateTo('admin')">监控
        </mdui-navigation-rail-item>
    ...
    <mdui-navigation-bar v-else :value="activeValue" scroll-behavior="hide">
        ...
        <mdui-navigation-bar-item v-if="showAdmin" icon="dashboard--outlined" value="admin" @click="navigateTo('admin')">监控
        </mdui-navigation-bar-item>
    </mdui-navigation-bar>
</template>
